...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn("rounded-xl border shadow-sm w-full", defaultClassNames.root),
        months: cn(
        ...
        nav: cn(
          "flex items-center gap-1 w-full absolute top-0 inset-x-0 justify-between border-b pb-1",

...
import propertyDescriptionValidations from "@validators/property-registration/propertyDescription";
...
const Form = () => {
  ...
  return (
    <formik.Formik
      validationSchema={propertyDescriptionValidations}
        ...
        <formik.Form className="grow flex flex-col justify-between gap-6">
          ...
          <div className="md:self-end self-center flex flex-wrap items-center justify-center gap-2">
            <Button className="min-w-36" variant="ghost" type="button" asChild>
              <Link href="/property-registration/property-equipments">

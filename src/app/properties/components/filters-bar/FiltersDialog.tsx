...
import ImageFacilitiesFilter from "@propertiesPage/components/filters-bar/filters/ImageFacilities";
import MortgagePriceFilter from "@propertiesPage/components/filters-bar/filters/MortgagePrice";
import PropertyTypeFilter from "@propertiesPage/components/filters-bar/filters/PropertyType";
import FacilitiesFilter from "@propertiesPage/components/filters-bar/filters/Facilities";
import RentPriceFilter from "@propertiesPage/components/filters-bar/filters/RentPrice";
import MeterageFilter from "@propertiesPage/components/filters-bar/filters/Meterage";
import LocationFilter from "@propertiesPage/components/filters-bar/filters/Location";
import RoomsFilter from "@propertiesPage/components/filters-bar/filters/Rooms";
